...
pushd .\bin
del *.pdb >NUL 2>NUL
cl %CommonCompilerFlags% ..\code\marcy.cpp -Fmmarcy.map -LD -link -PDB:marcy_%date:~-4,4%%date:~-10,2%%date:~-7,2%_%time:~0,2%%time:~3,2%%time:~6,2%.pdb -incremental:no -EXPORT:UpdateAndRender
